...
const Contact = () => {
  const contactInfo = [
    ...
    { icon: MapPin, title: "Address", content: "123 Sauna Street, Portland, OR 97201" },
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <div className="prose">
              <p className="text-gray-600 mb-4">
                Experience our saunas firsthand at our Portland showroom. Our experts are available 
